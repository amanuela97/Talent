          ...
          <div className="container mx-auto px-4 md:px-6 flex flex-col items-center">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-3 w-full">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-center text-gray-500">
                  Select your preferred date and time, then request a booking
                  with your chosen talent.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4">
                <div className="rounded-full bg-orange-500 p-3 text-white">
                ...
                <p className="text-center text-gray-500">
                  Sit back and enjoy as professional entertainers make your
                  event memorable.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <blockquote className="border-l-4 border-orange-500 pl-4 italic text-gray-500">
                  "We hired a clown for my daughter's birthday party and it was
                  the highlight of the event! The booking process was seamless
                  and the performer was absolutely amazing with the kids."
                </blockquote>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join thousands of satisfied customers who have found the
                  perfect talent for their events.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
